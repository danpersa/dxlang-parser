...
public class Method {
    ...
    private Method(@Nonnull final AccessType accessType, @Nonnull final String name, @Nonnull final String returnType,
            @Nonnull final List<Param> params, final boolean staticMethod, final Block block) {
        this.block = checkNotNull(block, "block should not be null");
    ...
    public static class Builder {
        ...
        @Nonnull
        public Builder withBlock(@Nonnull final Block block) {
            this.block = checkNotNull(block, "block should not be null");
            return this;
        }
        ...
        @Nonnull
        public Method build() {
            return new Method(accessType, name, returnType, ImmutableList.copyOf(params), staticMethod, block);
        }
    }
}
